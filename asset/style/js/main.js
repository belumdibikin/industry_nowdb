            ...
            "bootstrap": {
                "fnInit": function(oSettings, nPaging, fnDraw) {
                    ...
                    $(nPaging).append(
                            ...
                            '<li class="prev disabled"><a href="javascript:void(0)"><i class="fa fa-chevron-circle-left"></i> ' + oLang.sPrevious + '</a></li>' +
                            '<li class="next disabled"><a href="javascript:void(0)">' + oLang.sNext + ' <i class="fa fa-chevron-circle-right"></i></a></li>' +
                            '</ul>'
                            );
                    var els = $('a', nPaging);
