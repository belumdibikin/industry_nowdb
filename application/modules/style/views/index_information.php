...
<form method="post" class="form-horizontal form-box" onsubmit="return false;">
    <div class="form-box-content">
        ...
        <div class="form-group">
            <label class="control-label col-md-3" for="example-input-small">Lokasi Pendaftaran</label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <label class="control-label col-md-3" for="example-input-small">Alamat Operasional Perusahaan</label>
            <div class="col-md-1">
                Jalan
            </div>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <label class="control-label col-md-3" for="example-input-small">Tahun Terdaftar</label>
            <div class="col-md-2">
                <select id="example-select" name="example-select" class="form-control">
        ...
        <div class="form-group">
            <label class="control-label col-md-3" for="example-input-small">Jumlah Pegawai</label>
            <div class="col-md-2">
                <input type="text" id="example-input-small" name="example-input-small" class="form-control input-sm" />
            </div>
            <div class="col-md-2">
        ...
        <div class="form-group">
            <label class="control-label col-md-3" for="example-input-small">Alamat <i>Website</i></label>
            <div class="col-md-4">
                <input type="text" id="example-input-small" name="example-input-small" class="form-control input-sm">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3" for="example-input-small">Pemilik Resmi</label>
            <div class="col-md-4">
                <input type="text" id="example-input-small" name="example-input-small" class="form-control input-sm">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3" for="example-input-small">Luas Kantor</label>
            <div class="col-md-4">
                <select id="example-select" name="example-select" class="form-control">
                    <option value="">--Luas Kantor--</option>
                    <option value="lebih kecil dari 100">lebih kecil dari 100</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3" for="example-input-small">Keunggulan Perusahaan</label>
            <div class="col-md-6">
                <textarea class="form-control" style="resize: vertical;"></textarea>
            </div>
        </div>
