...
<table id="trd_table" class="table table-bordered table-hover" style="display:none;">
	<thead>
		<tr>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label class="control-label col-md-4" for="example-input-small">Foto Tradeshow</label>
					<div class="col-md-4">
						<input type="file">
					</div>
				</div>
