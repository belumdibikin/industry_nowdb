<form method="post" class="form-horizontal form-box" onsubmit="return false;">
    ...
    <div class="form-box-content">
        <div class="form-group">
            <label class="control-label col-md-3" for="example-input-small">Keunggulan Barang</label>
            <div class="col-md-6">
...
<table id="dataTables" class="table">
    <thead>
        <tr>
            ...
            <th class="hidden-xs hidden-sm">No. Registrasi</th>
            <th class="hidden-xs hidden-sm">Nama</th>
            <th class="hidden-xs hidden-sm">Mulai Berlaku</th>
