...
//                    }      
        ...
        <div class="qnt-holder">
            ...
            <a id="addto-cart" href="cart.html" class="le-button huge">kontak</a>
        </div><!-- /.qnt-holder -->
    </div><!-- /.body -->
    ...
    <div class="container">
        <div class="tab-holder">
            ...
            <ul class="nav nav-tabs simple" >
                ...
                <li><a href="#additional-info" data-toggle="tab">Informasi Tambahan</a></li>
                <li><a href="#reviews" data-toggle="tab">Komentar (3)</a></li>
            </ul><!-- /.nav-tabs -->
