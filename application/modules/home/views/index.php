            ...
            <div class="search-area">
                <form>
                    <div class="control-group">
                        <input  id="search-produk" class="search-field" placeholder="Search for item" />
                        ...
                        <ul class="categories-filter animate-dropdown">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" >
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">category</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">comapny</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">location</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">product detail</a></li>
                    ...
                    <div class="container">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3 sidemenu-holder">
                            ...
                            <div class="side-menu animate-dropdown">
                                <div class="head"><i class="fa fa-list"></i>Kategori</div>        
                                    ...
                                    <ul class="nav">
                                        <li class="dropdown menu-item">
                                            ...
                                            foreach ($category as $row) {
                                                echo "<a href='#' class='dropdown-toggle' data-toggle='dropdown'>" . $row->category_name . "</a>";
                                            }
                                            ?>

                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Semua Kategori</a>
                                            ...
                                            <footer id="footer" class="color-bg">
                                                ...
                                                <div class="copyright-bar">
                                                    <div class="container">
                                                        <div class="col-xs-12 col-sm-6 no-margin">
                                                            <div class="copyright">
                                                                © <a href="index.php?page=home">Media Center</a> - all rights reserved
                                                            </div><!-- /.copyright -->
                                                        </div>
                                                        <div class="col-xs-12 col-sm-6 no-margin">
